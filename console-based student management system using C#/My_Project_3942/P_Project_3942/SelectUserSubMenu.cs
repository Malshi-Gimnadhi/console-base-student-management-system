                    ...
                    while (!stop2)
                    {
                        ...
                        switch (MenuItems2[SelectedItem2].Title)
                        {
                            case "Modify User Details":
                                ...
                                Console.WriteLine("Press any key to modify user details again");
                                Console.ForegroundColor = ConsoleColor.Black;
                                break;
                            ...
                            case "Add Modules":
                                ...
                                foreach (var mod in get_user.Modules)
                                {
                                    ...
                                    {   
                                        Console.ForegroundColor = ConsoleColor.White;
                                        Console.WriteLine("This Module is already added..!!");
                                        isadded = true;
                                        break;
                                    }
                            ...
                            case "Remove Modules":
                                ...
                                if (isdeleted == false)
                                {
                                    ...
                                    Console.SetCursorPosition(2, 24);
                                    Console.WriteLine("Press any key to delete another module again");
                                    Console.ForegroundColor = ConsoleColor.White;
                                }
                                break;
                            ...
                            case "Add Grade":
                                ...
                                List_Of_Data.Display_GPA(get_user);
                                Console.WriteLine($"\nEnter the Registered Module Id to add Module Grade for the user: {get_user.FirstName}");
                                ...
                                Console.ForegroundColor = ConsoleColor.DarkYellow;
                                Console.SetCursorPosition(2, 24);
                                Console.WriteLine("Press any key to do again");
                                Console.ForegroundColor = ConsoleColor.White;
